...
Ce cours est évalué sur deux semestres. L'évaluation porte sur l'expression, les travaux pratiques et les rapports de recherche. Lors de chaque semestre, les étudiants ont l'opportunité d'effectuer différentes activités pour améliorer leur capacité à réaliser des recherches empiriques.
...
**Participation:** Il est attendu que les étudiants soient présents et engagés lors des séances synchrones, qu'elles soient en présentiel ou à distance. De même, il est attendu que les étudiants soient engagés et actifs de manière asynchrone en participant et contribuant aux discussions ayant lieu sur la plateforme de communication (voir la section **[Communication](#Communication)**.
...
Le premier semestre porte davantage sur les méthodes qualitatives. Le second semestre porte davantage sur les méthodes quantitatives.


Ces trois activités s'effectuent par groupe de trois étudiants.
